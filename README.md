...
1. **_Only in this file, `GettingStarted-Basic.md` and `files/--HOME--/.zprofile` files (and nowhere else):_** Find and replace the strings that reference my usernames to your equivalent ones (for eg, you can search for `jai-charan` and `jaicharan` and replace them with your values).
