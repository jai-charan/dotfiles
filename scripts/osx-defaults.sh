...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/jai-charan/dotfiles/master/scripts/osx-defaults.sh)"
#
# or run it without prompt questions:
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/jai-charan/dotfiles/master/scripts/osx-defaults.sh)" -s
#
