...
# curl -L https://raw.githubusercontent.com/jai-charan/dotfiles/master/scripts/fresh-install-of-osx-custom.sh | zsh

# Note: Change these as per your settings
USERNAME="${USERNAME:-$(whoami)}"
KEYBASE_USERNAME="${KEYBASE_USERNAME:-"jaicharan"}"
KEYBASE_HOME_REPO_NAME="${KEYBASE_HOME_REPO_NAME:-"home_repo"}"
