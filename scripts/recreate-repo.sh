...
usage() {
  ...
  echo "    eg: -f ${HOME}                             (will push to keybase://private/jaicharan/home_repo)"
  echo "    eg: ${HOME}/personal/${USERNAME}/profiles  (will push to keybase://private/jaicharan/profiles)"
  exit 1
}
...
git_url=$(extract_git_config_value remote.origin.url)   # "keybase://private/jaicharan/home_repo"
git_user_name=$(extract_git_config_value user.name)     # "jaicharan"
git_user_email=$(extract_git_config_value user.email)   # "sjcharan11@gmail.com"
